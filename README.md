...
To add NPCs to your world, simply drag and drop the NPC template from the script into the **Workspace**. Customize their behavior through the script properties, such as dialogue, quest triggers, and more!
